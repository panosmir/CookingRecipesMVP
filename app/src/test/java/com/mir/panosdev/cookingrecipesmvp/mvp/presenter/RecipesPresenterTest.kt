...
class RecipesPresenterTest {
    ...
    @Mock
    private val mApiService: RecipesApiService? = null
    @Mock
    private val mRecipeMapper: RecipeMapper? = null
    @Mock
    private val mStorage: Storage? = null
    @Mock
    private val mView: MainActivityMVP? = null
    @Mock
    private val mObservable: Observable<Response<RecipesResponse>>? = null

    @Captor
    private val captor: ArgumentCaptor<Subscriber<RecipesResponse>>? = null
